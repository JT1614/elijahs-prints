...
const WRITE_KEYS = ["assessment-v1", "products-v2", "categories-v1", "category-meta-v1"]; // TEMP — Halloween range final build, revert immediately after (see Brain/state.md session 26)
