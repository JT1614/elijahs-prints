...
const WRITE_KEYS = ["assessment-v1", "promo-codes-v1"]; // halloween-picks-v1 write access closed — the admin panel's HalloweenPicksEditor writes directly via the client Firebase SDK, not through this endpoint.
