// TEMPORARY (2026-09-16 session 31) — one-off admin-SDK Storage upload for the
// full 48-product image backlog audit (GIFs used directly as static images,
// MakerWorld sources serving application/octet-stream, oversized JPEG/PNG).
// Recreated from commit 3738bf4 (proven 2026-09-16 session 30 on 3 images) —
// same file, same scope, reused for the full batch per the next-session.md plan.
...
// CLAUDE.md history. DELETE this file once every upload is confirmed;
