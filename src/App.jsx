...
/* ═══════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════ */
const SEED_PRODUCTS = [
  { id: 100, name: "Tiny Character Figure", price: 1.00, category: "Fidgets & Toys", description: "Ultra-tiny detailed character figure. Smaller than a 50p coin!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "30 min", grams: 3, available: true, maxColors: 1 },
  { id: 101, name: "Spiral Cone Ornament", price: 1.00, category: "Fidgets & Toys", description: "Stunning multi-colour spiral cone with layered petal design.", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "6 hrs", grams: 80, available: true, maxColors: 1 },
  { id: 102, name: "Frog Planter", price: 1.00, category: "Planters", description: "Adorable frog planter. Perfect for succulents!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "5 hrs", grams: 120, available: true, maxColors: 1 },
  { id: 103, name: "Brick Block Keychain", price: 1.00, category: "Key Rings", description: "Classic building brick keychain with authentic stud detail.", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "1 hr", grams: 15, available: true, maxColors: 1 },
  { id: 104, name: "Skull Chain Keychain", price: 1.00, category: "Key Rings", description: "Four graduated skulls on a chain. Looks incredible in silk filaments!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "1.5 hrs", grams: 18, available: true, maxColors: 1 },
  { id: 105, name: "Skeleton Hoodie Keychain", price: 1.00, category: "Key Rings", description: "Cute skeleton character in a hoodie with lobster clasp.", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "2 hrs", grams: 20, available: true, maxColors: 1 },
  { id: 106, name: "Flexi Skeleton Keychain", price: 1.00, category: "Key Rings", description: "Fully articulated flexi skeleton with movable joints.", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "1.5 hrs", grams: 15, available: true, maxColors: 1 },
  { id: 107, name: "Demogorgon Keychain", price: 1.00, category: "Key Rings", description: "Articulated Demogorgon figure with opening flower head.", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "2 hrs", grams: 20, available: true, maxColors: 1 },
  { id: 108, name: "Mini Dinosaur", price: 1.00, category: "Key Rings", description: "Cute mini dinosaur figure. Tiny and adorable!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "45 min", grams: 8, available: true, maxColors: 1 },
  { id: 109, name: "Hexagonal Honeycomb Cube", price: 1.00, category: "Fidgets & Toys", description: "Mesmerising honeycomb cube made of individual hexagons.", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "8 hrs", grams: 150, available: true, maxColors: 1 },
  { id: 110, name: "Baby Alien Figure", price: 1.00, category: "Fidgets & Toys", description: "Detailed baby alien character bust with robe and big ears.", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "3 hrs", grams: 45, available: true, maxColors: 1 },
  { id: 111, name: "Articulated Crystal Dragon", price: 1.00, category: "Fidgets & Toys", description: "Articulated crystal dragon with spiky scales. Fully flexible!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "5 hrs", grams: 60, available: true, maxColors: 1 },
  { id: 112, name: "Desk Organiser", price: 1.00, category: "Planters", description: "Two-tone desk organiser with pen tubes and storage compartment.", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "6 hrs", grams: 100, available: true, maxColors: 1 },
  { id: 113, name: "Money Block", price: 1.00, category: "Fidgets & Toys", description: "3D printed novelty 100 money block. Great desk ornament!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "2 hrs", grams: 30, available: true, maxColors: 1 },
  { id: 114, name: "Rocktopus", price: 1.00, category: "Fidgets & Toys", description: "Articulated octopus with a detailed head. Tentacles really move!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "7 hrs", grams: 120, available: true, maxColors: 1 },
  { id: 115, name: "T-Rex Skull", price: 1.00, category: "Fidgets & Toys", description: "Detailed T-Rex dinosaur skull with opening jaw. Museum quality!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "6 hrs", grams: 80, available: true, maxColors: 1 },
  { id: 116, name: "Emerging Figure Bust", price: 1.00, category: "Fidgets & Toys", description: "Dramatic figure emerging from the surface. Detailed portrait bust.", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "4 hrs", grams: 60, available: true, maxColors: 1 },
  { id: 117, name: "Diamond Lattice Planter", price: 1.00, category: "Planters", description: "Elegant diamond lattice planter with matching saucer. Great for cacti!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "5 hrs", grams: 110, available: true, maxColors: 1 },
  { id: 118, name: "Remote Control Holder", price: 1.00, category: "Household", description: "Stylish 3-compartment remote control holder with geometric pattern. Keeps your living room tidy!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "5 hrs", grams: 120, available: true, maxColors: 1 },
  { id: 119, name: "Winged Crystal Dragon", price: 1.00, category: "Fidgets & Toys", description: "Stunning articulated dragon with spread wings and crystal-shard scales. Fully flexible body and tail!", colors: ["Matte Charcoal"], emoji: "", img: "IMGDATA", badge: null, printTime: "8 hrs", grams: 100, available: true, maxColors: 1 },
];
