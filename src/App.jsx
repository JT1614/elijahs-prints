...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .thankyou-label .url { color: #00c9a7; text-shadow: -1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff, 1px 1px 0 #fff; }
  ...
  .elijah-label .tagline b { color: #00c9a7; font-weight: 800; font-style: normal; text-transform: uppercase; text-shadow: -1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff, 1px 1px 0 #fff; }
  .elijah-label .url { color: #00c9a7; font-size: 6.5pt; font-family: 'Space Grotesk', sans-serif; font-weight: 600; margin-left: 3mm; white-space: nowrap; margin-top: 0; text-shadow: -1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff, 1px 1px 0 #fff; }
...
<div class="sheet">
  ...
  <div class="label"><div class="label-inner thankyou-label">
    ...
    <div class="submsg">I got <b style="color:#00c9a7;font-weight:800;text-transform:uppercase;text-shadow:-1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff, 1px 1px 0 #fff;">BANNED</b> from selling 3D prints at school,<br/>so I built this website instead!</div>
  ...
  <div class="label"><div class="label-inner elijah-label">
    ...
    <div style="font-size:6.5pt;color:#00c9a7;font-weight:600;text-shadow:-1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff, 1px 1px 0 #fff;">etprintworld.com</div>
    </div>`}
  </div></div>
</div>
